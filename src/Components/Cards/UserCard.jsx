    ...
    return (
        <div className="user-card p-2">
            ...
            <div className="flex items-end gap-3 mt-5">
                <StateCard label="Pending" count={userInfo?.pendingTasks || 0} status="Pending" />
                <StateCard label="In Progress" count={userInfo?.inProgressTasks || 0} status="In Progress" />
                <StateCard label="Completed" count={userInfo?.completedTasks || 0} status="Completed" />
            </div>
        </div>
    )
}
