...
const TaskCard = (
    ...
    return (
        ...
        >
            ...
            <div className={`px-4 border-l-[13px] ${status === "In progress" ? "border-cyan-500" : status === "completed" ? "border-indigo-500" : "border-violet-500"}`}>
            ...
            <div className="px-4">
                <div className="flex items-center justify-between my-1">
                    <div>
                        <label className='text-xs text-gray-500' htmlFor="">Start Date</label>
                        <p className="text-[13px] font-medium text-gray-900">
                            {moment(createdAt).format("Do MMM YYYY")}
                        </p>
                    </div>
                    <div>
                        <label className='text-xs text-gray-500' htmlFor="">Due Date</label>
                        <p className="text-[13px] font-medium text-gray-900">
